...
function Links() {
  const [links, setLinks] = useState([]); // State to store the list of links

  const handleAddLink = () => {
    if (links.length < 4) {
      setLinks([...links, links.length + 1]); // Add a number representing the link index
    }
  };
            ...
            <div className='w-[90%] h-auto rounded-lg bg-gray-50 m-12 flex flex-col justify-center'>
              ...
              <div>
                ...
                <p className='text-center text-sm m-8'>
                  Use the “Add new link” button to get started. Once you have more <br />
