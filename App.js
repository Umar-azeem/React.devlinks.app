      ...
      <div className=''>
        <div className='flex justify-center'>
          <nav className='w-full h-aut0 m-8 bg-white bg-inherit rounded-lg flex justify-between'>
            ...
            <div className='flex justify-between px-6  text-center m-4 cursor-pointer'><button onClick={() => setShowProfile(false)} className='bg-violet-100 text-indigo-500 text-lg flex text-center py-2 px-3 justify-center font-medium rounded-md w-32 h-12'><svg className='px-1 w-6 py-2' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
</svg>
Links</button><button onClick={() => setShowProfile(true)} className='hover:bg-violet-100 hover:text-indigo-500 text-zinc-500 text-lg text-center py-3 px-2 flex  font-medium rounded-md w-48 ml-8 h-14'><img src={pro} className='mt-1 px-4' ></img>Profile Details</button></div>
