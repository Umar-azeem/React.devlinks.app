          ...
          <nav className="w-full h-aut0 m-8 bg-white bg-inherit rounded-lg flex justify-between">
            ...
            <div className="flex justify-between px-6  text-center m-4 cursor-pointer">
              <button
                ...
                className="bg-violet-100 text-indigo-500 text-lg flex text-center py-2 px-3 justify-center font-medium rounded-md w-32 h-12"
              >
                <svg
              ...
              <button
                ...
                className="hover:bg-violet-100 hover:text-indigo-500 text-zinc-500 text-lg text-center py-3 px-2 flex  font-medium rounded-md w-48 ml-8 h-14"
              >
